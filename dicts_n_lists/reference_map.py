...
file_path_dicts = {
    ...
    '4473': {'material_list': f'{default_data_path}\\MATERIAL_LIST\\4473_MATERIAL_LIST.xlsx',
             'avz': f'{default_data_path}\\AVZ\\4473_AVZ.xlsx',
             'wz': f'{default_data_path}\\WZ\\4473_WZ.xlsx',
