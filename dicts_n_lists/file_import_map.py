...
device_dict_project = {
    ...
    '4355': {
        ...
        'col_complete_list': [
            ...
            'description_1', 'bg', 'din_1', 'din_2', 'group_mask', 'type', 'description_2', 'supplier_id', 'supplier',
            'car_area',
            'schematic', 'comment', 'stadler_id', 'status', 'person_responsible'
        ],
        'col_cutout_list': [
            'schema_position', 'h_u', 'stk_a', 'stk_b', 'stk_c', 'bezeichnung_deutsch',
            'bg', 'din_1', 'din_2', 'group_mask', 'typ', 'nenndaten', 'massbilder_bestellnummer',
    ...
    '4444': {
        ...
        'col_cutout_list': [
            'schema_position', 'h_u', 'stk_a', 'stk_b', 'stk_c', 'stk_pp', 'bezeichnung_deutsch',
            'bg', 'din_1', 'din_2', 'group_mask', 'typ', 'nenndaten', 'massbilder_bestellnummer',
            'lieferant_hersteller',
            'einbau_ort', 'schema', 'bemerkungen', 'stadlerid', 'be_status', 'verantwortlich']
    },
    '4533': {
        ...
        'col_cutout_list': [
            'schema_position', 'h_u', 'stk_a', 'stk_b', 'stk_c', 'stk_d', 'stk_e', 'stk_f', 'bezeichnung_deutsch',
            'bg', 'din_1', 'din_2', 'group_mask', 'typ', 'nenndaten', 'massbilder_bestellnummer',
            'lieferant_hersteller',
            'einbau_ort', 'schema', 'bemerkungen', 'stadler_id', 'be_status', 'verantwortlich']
    },
    '4547': {
        'col_change_dict': {
            'schema_position': 'schematic_position',
